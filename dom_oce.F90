...
CONTAINS
   ...
   INTEGER FUNCTION dom_oce_alloc()
      ...
      ALLOCATE( nimppt(jpnij) , ibonit(jpnij) , nlcit(jpnij) , nlcjt(jpnij) ,     &
         ...
         &      someone_east(jpnij) , someone_west(jpnij)  ,    &
         &      someone_north(jpnij), someone_south(jpnij) ,    &
         &      RB(jpnij) , &
         &      nx_west(jpnij) , nx_east(jpnij) , ny_south(jpnij) ,ny_north(jpnij) , &
         &      nx_self(jpnij) , ny_self(jpnij) , &
         &      col_shift_east(jpj), col_shift_west(jpj),  &
         &      col_shift_north(jpi),col_shift_south(jpi), &
