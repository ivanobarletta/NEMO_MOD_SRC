MODULE solmat
   ...
   USE timing          ! timing
   USE solpetsc        ! initialize Petsc Matrix
...
CONTAINS
   ...
   SUBROUTINE sol_mat( kt )
      ...
      gcp(:,:,3)   = 0.e0
      gcp(:,:,4)   = 0.e0
      gcp2(:,:,1)  = 0.e0 ! for Petsc
      gcp2(:,:,2)  = 0.e0 ! for Petsc
      gcp2(:,:,3)  = 0.e0 ! for Petsc
      gcp2(:,:,4)  = 0.e0 ! for Petsc
      !
      gcdprc(:,:)  = 0.e0
      gcdmat(:,:)  = 0.e0
      gcdmat2(:,:) = 1.e0 ! for Petsc
      !
      ...
      DO jj = 2, jpjm1                      ! matrix of free surface elliptic system
         DO ji = 2, jpim1
            ...
            IF ( bmask(ji,jj) /= 0 ) gcdmat2(ji,jj) = gcdmat(ji,jj)              ! in the ocean gcdmat2 = gcdmat
         END DO
      END DO
