MODULE sol_oce
   ...
   REAL(wp), PUBLIC, ALLOCATABLE, SAVE, DIMENSION(:,:,:) ::   gcp2    !: copy of matrix extra-diagonal elements
                                                                      !: used for Petsc
   REAL(wp), PUBLIC, ALLOCATABLE, SAVE, DIMENSION(:,:)   ::   gcx_pet !: used for Petsc
   INTEGER , PUBLIC, ALLOCATABLE, SAVE, DIMENSION(:)     ::   petsc_prealloc_d
   INTEGER , PUBLIC, ALLOCATABLE, SAVE, DIMENSION(:)     ::   petsc_prealloc_o
